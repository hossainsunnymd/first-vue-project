    ...
    <div class="w-full max-w-7xl mx-auto">
      <div class="pb-8 flex justify-between items-center gap-8">
        ...
        <div class="hidden md:flex gap-6 text-2xl">
          <a href="">
            <i
              class="flex items-center justify-center text-black border border-black rounded-full p-2 bi bi-arrow-left"
            ></i>
          </a>
          <a href="">
            <i
              class="flex items-center justify-center text-black border border-black rounded-full p-2 bi bi-arrow-right"
            ></i>
          </a>
        </div>
      </div>
      ...
      <div class="flex gap-4">
        <a href="" class="w-full flex flex-col gap-2">
          <div
            class="max-h-[300px] md:max-h-[500px] overflow-hidden rounded-xl shadow-xl relative"
          >
            <i
              class="flex items-center justify-center text-white rounded-full bg-black p-2 bi bi-arrow-up-right absolute top-4 right-4"
            ></i>
            <img
              class="w-full"
          ...
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. et dolor y
            etlerim dolor gils de nada!
          </p>
        </a>
        <a href="" class="w-full flex flex-col gap-2">
          <div
